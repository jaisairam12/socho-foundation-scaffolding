...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SOCHOYHAPE" },
      { name: "description", content: "SOCHOYHAPE — application foundation." },
      { property: "og:title", content: "SOCHOYHAPE" },
      { property: "og:description", content: "SOCHOYHAPE — application foundation." },
